...
public class DBliveryServiceTestCase {
	...
	public void testDeliverOrder() throws DBliveryException {
		...
		assertThrows(DBliveryException.class, () -> this.service.deliverOrder(o1.getId(), u2),
	...
	public void testCancelOrder() throws Exception {
		...
		assertThrows(DBliveryException.class, () -> this.service.cancelOrder(o3.getId()),
	...
	public void testFinishOrder() throws DBliveryException {
		...
		Order o1 = this.service.createOrder(orderDate, "Av. Corrientes 1405 2° B", Float.valueOf(-54.45F),
				Float.valueOf(-62.22F), u1);
		Order o2 = this.service.addProduct(o1.getId(), 1L, p1);
		assertThrows(DBliveryException.class, () -> this.service.finishOrder(o2.getId()),
