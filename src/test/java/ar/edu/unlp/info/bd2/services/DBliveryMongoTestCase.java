...
@ContextConfiguration(classes = { AppConfig.class,
		MongoDBConfiguration.class }, loader = AnnotationConfigContextLoader.class)
@Rollback(true)
public class DBliveryMongoTestCase {
	...
	@BeforeEach
	public void setUp() {
		this.client.getDatabase("bd2_grupo8").drop();
	}
	...
	public void testCreateProduct() {
		Supplier s1 = this.service.createSupplier("Burger King", "30710256443", "Av. Corrientes 956",
				Float.valueOf(-53.45F), Float.valueOf(-60.22F));
	...
	public void testCreateOrder() throws DBliveryException {
		...
		Date dob = cal.getTime();
		User u1 = this.service.createUser("hugo.gamarra@testmail.com", "123456", "hgamarra", "Hugo Gamarra", dob);
		Order o1 = this.service.createOrder(orderDate, "Av. Corrientes 1405 2° B", Float.valueOf(-54.45F),
				Float.valueOf(-62.22F), u1);
	...
	public void testDeliverOrder() throws DBliveryException {
		...
		assertThrows(DBliveryException.class, () -> this.service.deliverOrder(o1.getObjectId(), u2),
	...
	public void testCancelOrder() throws Exception {
		...
		assertThrows(DBliveryException.class, () -> this.service.cancelOrder(o3.getObjectId()),
				"The order can't be cancelled");
		Order o4 = this.service.createOrder(orderDate, "Av. Corrientes 1405 2° B", Float.valueOf(-54.45F),
				Float.valueOf(-62.22F), u1);
	...
	public void testFinishOrder() throws DBliveryException {
		...
		Order o1 = this.service.createOrder(orderDate, "Av. Corrientes 1405 2° B", Float.valueOf(-54.45F),
				Float.valueOf(-62.22F), u1);
		Order o2 = this.service.addProduct(o1.getObjectId(), 1L, p1);
		assertThrows(DBliveryException.class, () -> this.service.finishOrder(o2.getObjectId()),
				"The order can't be finished");
		Order o3 = this.service.deliverOrder(o2.getObjectId(), u2);
	...
	public void testGetProduct() {
		...
		assertEquals("Burger King", s1.getName());
		Product p1 = this.service.createProduct("Combo Stacker ATR", Float.valueOf(2521.2F), Float.valueOf(2.5F), s1);
		Product p2 = this.service.createProduct("Combo Tostado de Campo", Float.valueOf(2210.2F), Float.valueOf(2.2F),
				s1);
		Product p3 = this.service.createProduct("Combo Stacker ATR triple", Float.valueOf(1210F), Float.valueOf(1.8F),
				s1);
